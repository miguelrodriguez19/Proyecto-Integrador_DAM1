...
public class unirseEvento {
	...
	private JLabel lblUnirseEvento;
	private JLabel lblNombre;
	private JLabel lblNombreEvento;
	private JLabel lblFecha;
	private JLabel lblFechaVariable;
	private JLabel lblHora;
	private JLabel lblHoraVariable;
	private JLabel lblDeporte;
	private JLabel lblDeporteVariable;
	private JLabel lblParticipantes;
	private JLabel lblParticipantesVariable;
	private JLabel lblTipoEvento;
	private JLabel lblTipoEventoVariable;
	...
	private void initialize() {
		...
		frame.getContentPane().add(lblUnirseEvento);
		...
		btnLogo_1.setIcon(new ImageIcon(unirseEvento.class.getResource("/Imagenes/home-48.png")));
