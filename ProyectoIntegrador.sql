...
insert into users (usr, nombre, apellido, email, pwd, Fecha_nac, descripcion, DeporteFav, Valoraciones, cod_recuperacion, rol) values ('cwingfielda', 'Christoforo', 'Wingfield', 'cwingfielda@smh.com.au', 'C6zOAgFV5Htn', '2022-01-23', 'extend e-business technologies', 'Baloncesto', 802, 'user');
